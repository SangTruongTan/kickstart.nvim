  ...
  renderer = {
    icons = {
      ...
      show = {
        file = true,
        folder = true,
        folder_arrow = true, -- Optional: shows arrows for folders
        git = true, -- Optional: shows git status icons
      },
    },
    group_empty = true,
  },
  filters = {
    dotfiles = false, -- Show hiden files and directories
    git_ignored = false, -- Ignore .gitignore files
  },
}
